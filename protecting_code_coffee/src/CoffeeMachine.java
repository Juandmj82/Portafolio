        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    // Handle the exception and ask the user for the number of shots again
                    try {
                        ...
                        //Finally block to create the object
                    } finally {
                        myEspresso = new Espresso(espressoName, espressoRoast, espressoPrice, numberOfShots);
                    }
                ...
                case 2:
                    ...
                    Latte myLatte = null;
                    // Handle the exception and ask the user for the milk type again
                    try {
